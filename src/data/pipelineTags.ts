...
export const PIPELINE_TAGS: PipelineTagOption[] = [
  ...
  { id: 'text2text-generation', label: 'Text-to-Text Generation', icon: FileText },
  ...
  { id: 'document-question-answering', label: 'Document Question Answering', icon: FileSearch },
  { id: 'text-ranking', label: 'Text Ranking', icon: ListOrdered },
  { id: 'feature-extraction', label: 'Feature Extraction (Embeddings)', icon: Braces },
  { id: 'visual-question-answering', label: 'Visual Question Answering', icon: Eye },
  ...
  { id: 'zero-shot-classification', label: 'Zero-Shot Classification', icon: Sparkles },
];

export const PIPELINE_TAG_MAP: Record<string, PipelineTagOption> = Object.fromEntries(
  PIPELINE_TAGS.map((pt) => [pt.id, pt]),
);
