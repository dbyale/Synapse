  ...
  git_diff: {
    ...
    params: {
      ...
      properties: {
        ...
        target: {
          type: 'string',
          description: 'Branch name or commit hash to compare against',
        },
        context_lines: {
          type: 'number',
          description: 'Number of context lines to show (default: 3)',
    ...
    params: {
      ...
      properties: {
        ...
        files: {
          type: 'array',
          items: { type: 'string' },
          description: 'Files or glob patterns to stage',
        },
      },
    ...
    params: {
      ...
      properties: {
        ...
        start_timestamp: {
          type: 'string',
          description:
            'Start date in ISO 8601 format or relative date (e.g., "2 weeks ago")',
        },
        end_timestamp: {
          type: 'string',
          description: 'End date in ISO 8601 format or relative date',
        },
      },
      required: ['repo_path'],
    },
    ...
    params: {
      ...
      properties: {
        ...
        branch_type: {
          type: 'string',
          description:
            'Branch type: "local", "remote", or "all" (default: "local")',
        },
        contains: {
          type: 'string',
